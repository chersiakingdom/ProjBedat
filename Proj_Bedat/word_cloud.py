...
class wordcloud:
    ...
    def movie_cloud_image(self, file_name):
        no = {"더", "합니다", "입니다", "진짜", "하는", "없다", "너무", "정말", "이제", "지금", "이게", "좀", '절대', '그냥', '너희', '이번', '다음',
              '지금', '누가', '퍼트', '현재', "니들", "풀어주", "절대", "너희들", "안하", "단지", "어차피", "걔네", "하다", "하게", "들이", "만큼", "이것",
              ...
              "할만하다", "의해서", "연이서", "이어서", "잇따라", "뒤따라", "뒤이어", "결국", "의지하여", "기대여", "통하여", "자마자", "더욱더", "불구하고",
              "얼마든지", "마음대로"
            , "당연", "당신", "얼마", "살았", "하시", "고통스럽", "^ㅋ", "ㅋㅋ", "ㅋㅋㅋ", "^ㅎ", "ㅎㅎ", "내년", "어쩌", "가즈", "드러븐", "정도", "수가",
              "이전",
              '영화', '근데', '하나', '그리고', '정도', '이것', '너무', '진짜', '본거', '그거', '스럽다', '높다', '아주', '정말', '모두', '진짜', '완전',
              '있다', '아니다', '어떻다', '이렇다', '그렇다', '같다', '없다', '이다',
              '아마', '서로', '내내', '짧다', '가장', '모든'}
        font_path = 'static/font/BMDOHYEON_ttf.ttf'
        temp = Analysis.Analysis_noun(self.text)
        noun = dict(temp.noun_counter())
